			...
			<table>
				<s:form action="UserCreateCompleteAction">
					...
					<tr id="box">
						...
						<td>
							<s:property value="firstCana" escape="false" />
							<s:property value="lastCana" escape="false" />
						</td>
					</tr>
					<tr id="box">
						<td>
						...
						<td>
							<s:property value="postcodeNumber" escape="false" />
						</td>
					</tr>
					<tr id="box">
						<td>
						...
						<td>
							<s:property value="prefectureName" escape="false" />
						</td>
					</tr>
					<tr id="box">
						<td>
						...
						<td>
							<s:property value="cityName" escape="false" />
						</td>
					</tr>
					<tr id="box">
						<td>
